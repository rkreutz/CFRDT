...
final class LWWORDictionaryTests: XCTestCase {

    var a: LWWORDictionary<String, Int, DisambiguousTimeInterval>!
    var b: LWWORDictionary<String, Int, DisambiguousTimeInterval>!

    var dictOfSetsA: LWWORDictionary<String, ReplicatingSet<Int>, DisambiguousTimeInterval>!
    var dictOfSetsB: LWWORDictionary<String, ReplicatingSet<Int>, DisambiguousTimeInterval>!
